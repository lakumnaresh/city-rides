...
const LoginScreen = ({ navigation }: any) => {
  ...
  return (<SafeAreaView style={globalStyles.rootView}>
    <View style={styles.container}>
      <Text style={styles.title}>Login to City Rides</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 24, textAlign: 'center', color: '#2c2d31ff' },
  input: { borderWidth: 1, borderColor: '#d1d5db', padding: 12, borderRadius: 8, marginBottom: 16 },
  button: { backgroundColor: '#2c2d31ff', padding: 14, borderRadius: 8 },
